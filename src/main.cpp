      ...
      if (s != "") {
        ...
        if (event == "telemetry") {
          ...
          */
          ...
          // CTE is the fit poly evaluated at 0 which is just the constant term
          double cte = coeffs[0];

          // Calculate the orientation error
          // epsi is the derivative of the fit poly evaluated at 0
          // this reduces to just the 1st order term
